...
function VerifyEmail() {
  ...
  return (
    <div className='w-11/12 h-screen -mt-14 mx-auto flex justify-center items-center '>
    
        <div className='max-w-[500px] p-4 lg:p-8'>

            <p className="text-richblack-5 font-semibold text-[1.875rem] leading-[2.375rem]">Verify Email</p>
